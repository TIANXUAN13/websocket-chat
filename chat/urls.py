...
urlpatterns = [
    ...
    path('dm/<str:username>/emoji/<int:emoji_id>/send/', views.send_direct_emoji, name='send_direct_emoji'),
    path('dm/<str:username>/emoji/favorite/<int:message_id>/', views.favorite_direct_image_emoji, name='favorite_direct_image_emoji'),
    path('dm/<str:username>/attachments/', views.upload_direct_attachment, name='upload_direct_attachment'),
